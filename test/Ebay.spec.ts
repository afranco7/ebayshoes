    ...
    describe('When filtering for brand and size', () => {
      ...
      describe('When Showing number of results', () => {
        ...
        describe('When sorting the results by price', () => {
          beforeAll(async () => {
            const orderByPriceAscendantPage: 
            OrderByPriceAscendantPage = new OrderByPriceAscendantPage();         
          ...
          describe('When taking the name and the price of the first 5 products', () => {
            beforeAll(async () => {
              ...
              const listOfProductsPricePage: 
              ListOfProductsPricePage = new ListOfProductsPricePage();
